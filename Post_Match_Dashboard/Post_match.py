...
whovis.plot_clusters_event_opp_half(ax3,data=data,teamid=opta_home_teamID,k=4,filter="FinalThirdPasses == True & is_open_play == True")
whovis.plot_event_clusters_away(ax2,data=data,teamid=opta_away_teamID,k=6,filter="is_progressive == True & is_open_play == True")
whovis.plot_clusters_event_opp_half(ax4,data=data,teamid=opta_away_teamID,k=4,filter="FinalThirdPasses == True & is_open_play == True")
...
whovis.plot_xT_heatmap(ax1,data=home,teamId=opta_home_teamID,color=homecolor)


whovis.plot_xT_heatmap_away(ax2,data=away,teamId=opta_away_teamID,color=awaycolor)


whovis.plot_deep_comp_team(ax3,data=home,teamId=opta_home_teamID,passColor='#8fb5ab',carryColor='#fa7d3b',radius=26)
whovis.plot_deep_comp_team(ax4,data=away,teamId=opta_away_teamID,passColor='#8fb5ab',carryColor='#fa7d3b',radius=26)
...
whovis.plot_team_heatmap(ax1,data=home,teamid=opta_home_teamID,color=homecolor,sd=0)

whovis.plot_team_heatmap_away(ax2,data=away,teamid=opta_away_teamID,color=awaycolor,sd=0)
...
ax2.set_title(f"{away_name} Territory Map Offensive Actions",size="6", c="#EFE9F4", loc="center")

ax3.set_title(f"{home_name} Territory Map Defensive Actions",size="6", c="#EFE9F4", loc="center")
